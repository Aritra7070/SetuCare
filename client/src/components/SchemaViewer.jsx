  ...
  const schemas = {
    User: {
      ...
      fields: [
        ...
        { name: 'preferredLanguage', type: 'String (Enum)', required: false, details: "['en', 'hi', 'mr'], default: 'en'" },
    ...
    Patient: {
      ...
      fields: [
        ...
        { name: 'preferredLanguage', type: 'String (Enum)', required: false, details: "['en', 'hi', 'mr'], default: 'mr'" },
        { name: 'createdAt / updatedAt', type: 'Date', timestamps: true, details: 'Mongoose timestamps' },
      ],
    },
    Encounter: {
